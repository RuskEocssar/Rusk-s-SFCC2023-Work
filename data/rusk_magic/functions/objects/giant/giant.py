...
def main():
    ...
    # ボーン
    obj.add_bone("giant"      ,"root"      ,[   0,  92 ,0])
    obj.add_bone("bottom"     ,"giant"     ,[   0,  92 ,0])
    obj.add_bone("up"         ,"giant"     ,[   0,  92, 0])
    obj.add_bone("right_hip"  ,"bottom"    ,[  -9,  92, 0])
    obj.add_bone("right_leg"  ,"right_hip" ,[ -12,  80, 0])
    obj.add_bone("right_lap"  ,"right_leg" ,[ -12,  00, 0])
    obj.add_bone("right_foot" ,"right_lap" ,[ -12, -90, 0])
    obj.add_bone("left_hip"   ,"bottom"    ,[   9,  92, 0])
    obj.add_bone("left_leg"   ,"left_hip"  ,[  12,  80, 0])
    obj.add_bone("left_lap"   ,"left_leg"  ,[  12,   0, 0])
    obj.add_bone("left_foot"  ,"left_lap"  ,[  12, -90, 0])
    obj.add_bone("stomach"    ,"up"        ,[   0,  92, 0])
    obj.add_bone("chest"      ,"stomach"   ,[   0, 112, 0])
    obj.add_bone("head"       ,"chest"     ,[   0, 142, 5])
    obj.add_bone("right_arm"  ,"chest"     ,[ -22, 137, 0])
    obj.add_bone("right_wrist","right_arm" ,[ -82, 137, 0])
    obj.add_bone("left_arm"   ,"chest"     ,[  22, 137, 0])
    obj.add_bone("left_wrist" ,"left_arm"  ,[  82, 137, 0])
    # ディスプレイ
    obj.add_display("right_hip"  ,"right_hip"  ,"item",translation=[  -9,  81,-2],scale=[18,20,17])
    obj.add_display("right_leg"  ,"right_leg"  ,"item",translation=[ -12,  39, 0],scale=[10,80,10])
    obj.add_display("right_lap"  ,"right_lap"  ,"item",translation=[ -12, -45, 0],scale=[ 8,90, 8])
    obj.add_display("right_foot" ,"right_foot" ,"item",translation=[ -12, -95, 7],scale=[10,10,25])
    obj.add_display("left_hip"   ,"left_hip"   ,"item",translation=[   9,  81,-2],scale=[18,20,17])
    obj.add_display("left_leg"   ,"left_leg"   ,"item",translation=[  12,  39, 0],scale=[10,80,10])
    obj.add_display("left_lap"   ,"left_lap"   ,"item",translation=[  12, -45, 0],scale=[ 8,90, 8])
    obj.add_display("left_foot"  ,"left_foot"  ,"item",translation=[  12, -95, 7],scale=[10,10,25])
    obj.add_display("stomach"    ,"stomach"    ,"item",translation=[   0, 101,-2],scale=[30,20,15])
    obj.add_display("chest"      ,"chest"      ,"item",translation=[   0, 126, 0],scale=[45,30,20])
    obj.add_display("head"       ,"head"       ,"item",translation=[   0, 159, 5],scale=[40,40,40])
    obj.add_display("right_arm"  ,"right_arm"  ,"item",translation=[ -52, 136, 0],scale=[60, 8, 8])
    obj.add_display("right_wrist","right_wrist","item",translation=[-111, 136, 0],scale=[60, 7, 7])
    obj.add_display("left_arm"   ,"left_arm"   ,"item",translation=[  52, 136, 0],scale=[60, 8, 8])
    obj.add_display("left_wrist" ,"left_wrist" ,"item",translation=[ 111, 136, 0],scale=[60, 7, 7])
