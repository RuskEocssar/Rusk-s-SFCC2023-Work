...
## 走るアニメーション
    ...
    execute if score #pegasus_run time matches 10 at @s run particle end_rod ^1.0 ^-1.9 ^-0.5 0.1 0 0.1 0 1
    execute if score #pegasus_run time matches 11 at @s run particle end_rod ^-1.2 ^-1.9 ^-0.5 0.1 0 0.1 0 1
    ...
    execute if score #pegasus_run time matches 12 at @s run particle end_rod ^0.8 ^-1.9 ^0.5 0.1 0 0.1 0 1
    execute if score #pegasus_run time matches 13 at @s run particle end_rod ^-1.4 ^-1.9 ^0.5 0.1 0 0.1 0 1
    ...
    execute at @s run particle dust 1 1 1 1 ~ ~ ~ 1 1 1 0 1
