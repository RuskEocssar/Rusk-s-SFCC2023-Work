#> rusk_magic:objects/painting/animation/fluffy_empty
### 半目でふわふわ
...
## ふわふわアニメーション
    ...
    # 最初
    execute if score @s time1 matches -1 run data modify storage rusk_magic: _ set from storage rusk_magic: objects.painting.fluffy_empty[0]
    # スコア
    execute if score @s time1 matches 0 run data modify storage rusk_magic: _ set from storage rusk_magic: objects.painting.fluffy_empty[1]
    ...
    execute if score @s time1 matches 12 run data modify storage rusk_magic: _ set from storage rusk_magic: objects.painting.fluffy_empty[2]
